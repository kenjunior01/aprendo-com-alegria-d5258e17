// Shopify Storefront API helpers — real cart + checkout integration.
// NEVER use manual checkout permalinks; always create carts via cartCreate.

import { toast } from "sonner";

export const SHOPIFY_API_VERSION = "2025-07";
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "aprendo-com-alegria-gj91j-dr7nzfr6.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "5095f5a79730f16c41700985ff43ea3d";
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: pagamento necessário", {
      description:
        "A API do Shopify requer um plano ativo. Visita admin.shopify.com para atualizar.",
    });
    return null;
  }
