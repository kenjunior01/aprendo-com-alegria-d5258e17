...
export const Route = createFileRoute("/desafios")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Desafios diários da IA, batalhas épicas com amigos e ligas nacionais.",
      },
...
function DesafiosPage() {
  ...
  const [ranking, setRanking] = useState<Awaited<ReturnType<typeof getWeeklyRanking>>>({
    ranking: [],
    me: null,
  });
    ...
    <div className="min-h-[100dvh] bg-slate-50 pb-28 md:pb-12">
      ...
      <main id="main-content" className="mx-auto max-w-[48rem] px-4 py-6">
          ...
          <div className="relative z-10 flex flex-col items-center text-center sm:flex-row sm:text-left">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-lg font-medium text-white/80">
                Vence desafios, sobe de liga e torna-te uma lenda!
              </p>
              <div className="mt-4 flex flex-wrap justify-center gap-2 sm:justify-start">
                <Badge className="bg-white/20 text-white backdrop-blur-md">🏆 LIGA DE OURO</Badge>
                <Badge className="bg-yellow-400 text-amber-950 font-bold">
                  🔥 {profile.streak} DIAS
                </Badge>
              </div>
            </div>
        ...
        <Link
          ...
          className="group relative mb-8 flex items-center gap-4 overflow-hidden rounded-3xl border-2 border-emerald-500 bg-emerald-50 p-4 transition-all hover:scale-[1.02] active:scale-[0.98]"
        >
          ...
          <div className="flex-1">
            <h2 className="font-display text-xl font-bold text-emerald-900 leading-tight">
              Grande Desafio Moçambicano 🇲🇿
            </h2>
            <p className="text-sm text-emerald-700/80">
              Explora as províncias e ganha prémios exclusivos de cultura geral.
            </p>
          </div>
        ...
        {!myUserId && !loading && (
          ...
          >
            ...
            <p className="text-sm text-amber-800 mb-4">
              Cria conta para salvar as tuas medalhas na Arena.
            </p>
            <Button
              asChild
              className="bg-amber-500 hover:bg-amber-600 border-b-4 border-amber-700 active:border-b-0 transition-all"
            >
        ...
        <Tabs defaultValue="ai" className="w-full">
          <TabsList className="mb-8 grid w-full grid-cols-5 h-16 bg-white p-2 rounded-2xl shadow-lg">
            <TabsTrigger
              value="ai"
              className="rounded-xl data-[state=active]:bg-primary data-[state=active]:text-white transition-all gap-2"
            >
            ...
            <TabsTrigger
              value="pvp"
              className="rounded-xl data-[state=active]:bg-purple-600 data-[state=active]:text-white transition-all gap-2"
            >
            ...
            <TabsTrigger
              value="ligas"
              className="rounded-xl data-[state=active]:bg-amber-500 data-[state=active]:text-white transition-all gap-2"
            >
            ...
            <TabsTrigger
              value="ranking"
              className="rounded-xl data-[state=active]:bg-blue-600 data-[state=active]:text-white transition-all gap-2"
            >
            ...
            <TabsTrigger
              value="historico"
              className="rounded-xl data-[state=active]:bg-slate-700 data-[state=active]:text-white transition-all gap-2"
            >
              ...
              {loading ? (
                ...
                >
                  ...
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    <Badge className="bg-xp px-4 py-2 text-lg font-black shadow-lg">
                      +{aiChallenge.coin_reward} 🪙
                    </Badge>
                  </div>
                  ...
                  <Button
                    asChild
                    size="lg"
                    className="h-16 w-full rounded-2xl bg-primary text-xl font-black shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all"
                  >
                    <Link
                      to="/licao/$subjectId/$lessonId"
                      params={{
                        subjectId: aiChallenge.subject_id,
                        lessonId: aiChallenge.lesson_id,
                      }}
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 font-display">
                    A IA ainda está a estudar o teu perfil...
                  </p>
                </div>
              )}
            </TabsContent>
              ...
              {challenges.filter((c) => c.kind === "pvp").length === 0 ? (
                ...
                <div role="list" className="grid gap-4 sm:grid-cols-2">
                  {challenges
                    ...
                    .map((c) => {
                      const myScore =
                        c.creator_id === myUserId ? c.creator_score : c.opponent_score;
                      const oppScore =
                        c.creator_id === myUserId ? c.opponent_score : c.creator_score;
                      const result =
                        c.status === "completed"
                          ? c.winner_id === myUserId
                            ? "🏆 VITÓRIA!"
                            : c.winner_id == null
                              ? "🤝 EMPATE"
                              : "💪 DERROTA"
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between gap-4 py-4">
                            ...
                            <div className="text-purple-300 font-display text-xl font-black italic">
                              VS
                            </div>
                            <div className="text-center flex-1">
                          ...
                          {myScore == null && c.status !== "expired" && (
                            <Button
                              asChild
                              className="w-full bg-purple-600 hover:bg-purple-700 shadow-lg mt-2"
                            >
                              <Link
                                to="/licao/$subjectId/$lessonId"
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white flex justify-between items-center">
        ...
        {ranking.me?.rank && (
          <div className="text-center bg-white/20 px-4 py-2 rounded-2xl backdrop-blur-md border border-white/30">
            <p className="text-xs uppercase font-bold opacity-80 leading-none mb-1 text-blue-100">
              O Teu Rank
            </p>
...
function FriendsBlock({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-[2rem] bg-indigo-900 p-6 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-indigo-200 text-sm mb-4">
            Partilha o teu código único para batalharem.
          </p>
      ...
      {incoming.length > 0 && (
        <div className="pt-4">
          <p className="mb-3 font-display text-sm font-bold text-slate-500 uppercase tracking-widest px-2">
            Pedidos Pendentes
          </p>
          <div role="list" className="grid gap-2">
            {incoming.map((f) => (
              ...
              >
                ...
                <span className="flex-1 font-display text-sm font-bold text-slate-700">
                  {f.name}
                </span>
                <div className="flex gap-1">
                  <Button
                    ...
                    onClick={() => onRespond(f.friendshipId, true)}
                    aria-label="Aceitar"
                  >
                  ...
                  <Button
                    ...
                    onClick={() => onRespond(f.friendshipId, false)}
                    aria-label="Rejeitar"
                  >
                    <X className="h-5 w-5" />
                  </Button>
          ...
          <div role="list" className="grid grid-cols-2 gap-3">
            {accepted.map((f) => (
              ...
              >
                ...
                <span className="font-display text-base font-bold text-slate-800 line-clamp-1">
                  {f.name}
                </span>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          size="sm"
          variant="secondary"
          className="h-10 w-full rounded-xl bg-indigo-50 text-indigo-700 hover:bg-indigo-100 font-bold"
        >
      ...
      <DialogContent className="max-w-[28rem] rounded-[2rem]">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm text-muted-foreground">
            Inicia um desafio PvP contra este amigo.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="pt-6">
          ...
          <Button
            ...
            onClick={async () => {
              setBusy(true);
              try {
                await onConfirm(subjectId, lessonId);
                setOpen(false);
              } finally {
                setBusy(false);
              }
...
function Section({
  ...
  return (
    <div>
      <h3 className="mb-4 font-display text-sm font-black uppercase tracking-[0.2em] text-slate-500 px-2">
        {title}
      </h3>
          ...
          return (
            ...
            >
              <div className="mb-2 flex items-center justify-between">
                <span className="font-display text-sm font-bold capitalize text-slate-800">
                  {c.subject_id.replace("-", " ")}
                </span>
                <span
                  className={cn(
