...
const BASE_URL = "https://alegria.online";
...
const entries: SitemapEntry[] = [
  ...
  { path: "/aprender/portugues",        changefreq: "monthly", priority: "0.9" },
  { path: "/aprender/matematica",       changefreq: "monthly", priority: "0.9" },
  { path: "/aprender/estudo-do-meio",   changefreq: "monthly", priority: "0.9" },
