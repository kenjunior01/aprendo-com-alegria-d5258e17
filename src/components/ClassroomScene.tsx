...
export function ClassroomScene({ profile }: Props) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
      ...
      {/* ═══ Bandeirinhas ═══ */}
      <div className="absolute inset-x-0 top-0 border-t-[3px] border-amber-800/50">
      ...
      {/* ═══ Janela com céu real ═══ */}
      <div className="absolute left-[3%] top-[8%] h-[34%] w-[21%] min-w-[96px] max-w-[190px] sm:left-[5%] sm:top-[9%]">
        <div
      ...
      <div
        ...
        className="absolute right-[3%] top-[13%] h-12 w-12 rounded-full border-4 border-amber-800 bg-white shadow-lg sm:right-[5%] sm:top-[14%] sm:h-16 sm:w-16"
      >
      ...
      <button
        ...
        className="group pointer-events-auto absolute left-[56%] top-[11%] h-[33%] max-h-[300px] min-h-[150px] w-[44%] min-w-[220px] max-w-[540px] -translate-x-1/2 md:left-1/2 md:w-[46%]"
      >
        {/* Moldura de madeira */}
      ...
      <motion.button
        ...
        className="pointer-events-auto absolute right-[5%] top-[30%] hidden h-[15%] w-[8%] min-w-[56px] max-w-[80px] rotate-3 rounded-md border-4 border-white bg-white/95 p-1 shadow-lg sm:block"
      >
      ...
      <div className="absolute bottom-[30%] right-[2%] w-[26%] min-w-[150px] max-w-[220px] sm:right-[4%]">
      ...
      {/* ═══ Planta ═══ */}
      <div className="absolute bottom-[26%] left-[3%] sm:left-[5%]">
      ...
      {/* ═══ Avião de papel ═══ */}
      <span className="scene-plane absolute top-[20%] text-2xl opacity-0" aria-hidden>
        ✈️
      </span>
      ...
      <button
        ...
        aria-pressed={lampOn}
        className="pointer-events-auto absolute bottom-[21%] right-[4%] flex flex-col items-center transition-transform active:scale-90"
      >
        <span
          className={cn(
      ...
      {/* ═══ Secretária ═══ */}
      <div className="absolute bottom-[13%] left-1/2 w-[68%] max-w-[440px] -translate-x-1/2">
